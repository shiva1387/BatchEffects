...
plot(ms_data_total$rt,ms_data_total$mz,pch=1,main="algae_417reps_retcor_MPP_sorted",ylab="m/z",xlab="rt")
dev.off()

### Measure of variation ########

png('boxplot1.png',width=8000)
boxplot(log(ms_data_22),range=0,xlab="Samples",ylab="Log2 feature counts",las=1,cex.axis=0.7)
dev.off()
...
bray_grps.D <- vegdist(t(log1p(ms_data_day12)), "bray") #calculating distance matrix using bray curtis
...
## for day 12
bray_grps.D_day12 <- vegdist(t(log1p(ms_data_day12)), "bray") #calculating distance matrix using bray curtis
...
pdf(file="v1PCOA_ordplot_zeroCor_rem5rep.pdf",width=12, height=12, paper="a4r")
fig<-ordiplot(scores(pc_day12)[,c(1,2)], type="t", main="PCoA Samples",cex=0.5)
dev.off()
